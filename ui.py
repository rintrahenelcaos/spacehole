...
from PyQt5.QtGui import QIcon, QPixmap, QPainter, QBrush, QPen, QMouseEvent, QHoverEvent
...
class Main_window(QMainWindow):
    ...
    def initUI(self):
        ...
        self.info_phase_label.setText("info_phase_label")
        ...
        self.info_pict.setStyleSheet("color: white; background-color: white")
        ...
        self.hand_frame.setGeometry(QtCore.QRect(1000, 390, 228, 558))
        ...
        #print(self.hand_frame.findChildren(QLabel))
        """self.hand_frame = QtWidgets.QFrame(self)
        self.hand_frame.setGeometry(QtCore.QRect(10, 746 ,1230 ,159))
        self.hand_frame.setStyleSheet("QWidget { background-color: #1E1E1E}")
        self.hand_frame.setFrameShape(QtWidgets.QFrame.Box)
        self.hand_frame.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.hand_frame.setLineWidth(2)"""
    ...
    def infoframeshow(self, identif, *args):
        #self.information_frame.show()
    ...
    def randomframeactualizer(self, referenceframe, showing):
        ...
        for i in tobeadded:
            if i in played: # <--- adds card
                print("add",i)
                #ident = identifierextractor(self.db.invertedcardselector("card", i))[0]
    ...
    def gameplay(self):
        ...
        elif self.counterturn == 4:  self.battlepreparationfunction()
        elif self.counterturn == 5:  self.battledefendersfunction()
        elif self.counterturn == 6:  self.battlelassersfunction()
        elif self.counterturn == 7:  self.battledomesfunction()
        elif self.counterturn == 8:  self.battlebasefunction()
        elif self.counterturn == 9:  self.buildphasefunction()
